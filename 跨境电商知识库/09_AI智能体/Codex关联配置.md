...
| Obsidian Vault | `E:/亚马逊Codex独立团/跨境电商知识库` | Amazon-AI-OS 知识底座 |
| 本地亚马逊资料源 | `E:/亚马逊Codex独立团/亚马逊知识库` | 原始资料来源 |
...
| 闭环配置候选 | `E:/亚马逊Codex独立团/跨境电商知识库/09_AI智能体/amazon-ai-os.config.v2.json` | 受保护配置待部署时的正式候选版本 |
| GitHub 私有仓库 | `Amazon-AI-OS` | 多电脑同步、版本追溯、成员权限管理；本地 `.gitignore` 已准备 |

## Codex 默认读取顺序

1. `AGENTS.md` 和 `.agentignore`
2. `09_AI智能体/Amazon-AI-OS架构总控.md`
3. `09_AI智能体/智能体岗位路由表.md`
